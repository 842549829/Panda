...
namespace Panda.Net.Migrations
{
    ...
    [Migration("20250123030741_net91")]
    partial class net91
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Panda.Net.Bases.Announcements.Entities.Announcement", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AbpAnnouncements", null, t =>
                        {
                            t.HasComment("公告");
                        });
                });

            modelBuilder.Entity("Panda.Net.Bases.Departments.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("HospitalZone")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("Panda.Net.Bases.Departments.DepartmentType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Panda.Net.Bases.FileStores.FileProjectName", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AbpFilesProjectName", (string)null);
                });

            modelBuilder.Entity("Panda.Net.Bases.FileStores.FileStore", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("Abpfiles", (string)null);
                });

            modelBuilder.Entity("Panda.Net.Bases.FileStores.FileWhiteList", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AbpFilesWhiteList", (string)null);
                });

            modelBuilder.Entity("Panda.Net.Bases.Users.Entities.Doctor", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Panda.Net.Bases.Departments.Department", b =>
                {
                    b.HasOne("Panda.Net.Bases.Departments.DepartmentType", "DepartmentType")
                        .WithMany()
