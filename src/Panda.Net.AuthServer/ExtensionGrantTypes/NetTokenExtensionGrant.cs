...
public class NetTokenExtensionGrant : AbpOpenIdDictControllerBase, ITokenExtensionGrant
{
            ...
            using (CurrentTenant.Change(tenant?.Id))
            {
                ...
                if (string.IsNullOrWhiteSpace(request.Username))
                {
                    var properties = new AuthenticationProperties(new Dictionary<string, string>
                    {
                        ...
                        [OpenIddictServerAspNetCoreConstants.Properties.ErrorDescription] = "username is empty!"
                    }!);
                ...
                if (string.IsNullOrWhiteSpace(request.Password))
                {
                    ...
                    {
                        [OpenIddictServerAspNetCoreConstants.Properties.Error] = OpenIddictConstants.Errors.InvalidGrant,
                        [OpenIddictServerAspNetCoreConstants.Properties.ErrorDescription] = "password is empty!"
                    }!);
                    return Forbid(properties, OpenIddictServerAspNetCoreDefaults.AuthenticationScheme);
                }
