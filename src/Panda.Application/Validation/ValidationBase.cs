...
namespace Panda.Application.Validation;

public class ValidationBase<T> : AbstractValidator<T>, ITransientDependency
{
    /// <summary>
    /// 验证身份证合理性
    /// </summary>
    ...
    protected static bool ValidationTelephone(string phone)
    {
        return System.Text.RegularExpressions.Regex.IsMatch(phone,
               ...
               System.Text.RegularExpressions.Regex.IsMatch(phone, @"^[1][3-9][0-9]\d{8}$") || phone.IsNullOrWhiteSpace();
    }
